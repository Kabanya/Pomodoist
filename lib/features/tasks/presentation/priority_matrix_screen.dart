...
class _PriorityMatrix extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    for (final item in items.where((task) => !task.isCompleted)) {
          ...
          child: ClipRRect(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  color: priorityColor.withValues(alpha: isDark ? 0.10 : 0.06),
                          ...
                          children: [
                            ...
                            if (showMeaning) ...[
                              ...
                              Text(
                                ...
                                key: Key('priority-matrix-meaning-p$priority'),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                ...
                Padding(
                  ...
                  child: QuickAddBar(defaultPriority: priority),
                ),
                if (tasks.isEmpty)
                  SizedBox(
                    height: 96,
                  ...
                  for (var index = 0; index < tasks.length; index++) ...[
                    TaskListItem(task: tasks[index], enableSubtaskDrop: false),
