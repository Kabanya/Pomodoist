const messages = {
  en: {
    ...
    focusHint: "Choose a task and give it 25 minutes of your attention.",
  ...
  ru: {
    ...
    focusHint: "Выберите задачу и посвятите ей 25 минут внимания.",
  ...
  de: {
    ...
    focusHint: "Wähle eine Aufgabe und widme ihr 25 Minuten.",
  ...
  es: {
    ...
    focusHint: "Elige una tarea y dedícale 25 minutos.",
  ...
  fr: {
    ...
    focusHint: "Choisissez une tâche et consacrez-lui 25 minutes.",
  ...
  ar: {
    ...
    focusHint: "اختر مهمة وخصص لها 25 دقيقة من انتباهك.",
